 ...
 * generated in the dk.dtu.ccsd.jaxb package. <p>An ObjectFactory allows you to programatically
...
public class ObjectFactory {
  ...
  static QName _ResourceDescriptionsDescriptionBr_QNAME
    = new QName("http://datacite.org/schema/kernel-3", "br");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: dk.dtu.ccsd.jaxb
   */
   ...
   */
  public Resource.RelatedIdentifiers.RelatedIdentifier
  createResourceRelatedIdentifiersRelatedIdentifier() {
   ...
   */
  public Resource.AlternateIdentifiers.AlternateIdentifier
  createResourceAlternateIdentifiersAlternateIdentifier() {
   ...
   */
  public Resource.Contributors.Contributor.NameIdentifier
  createResourceContributorsContributorNameIdentifier() {
   ...
   */
  @XmlElementDecl(namespace = "http://datacite.org/schema/kernel-3", name = "br",
      scope = Resource.Descriptions.Description.class)
  public JAXBElement<String> createResourceDescriptionsDescriptionBr(String value) {
    return new JAXBElement<String>(_ResourceDescriptionsDescriptionBr_QNAME,
        String.class, Resource.Descriptions.Description.class, value);
  }
